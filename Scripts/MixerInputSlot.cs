...
public class MixerInputSlot : MonoBehaviour, IDropHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    [Header("UI References")]
    public Image iconDisplay;
    public TMP_InputField amountInput;
    public TextMeshProUGUI unitText;
    public MixerMachine machine;
